...
while True:
    params = {
        ...
        '$where': "fecha_de_publicacion >= '2026-01-16' AND fecha_de_publicacion < '2026-02-16'"
    }
...
df.to_parquet('secop_prueba.parquet', index=False, engine='pyarrow')

print("Archivo guardado correctamente")

#===================== SEGUNDO PASO PARA LA PRUEBA, VER =========================
archivo = 'secop_prueba.parquet'
